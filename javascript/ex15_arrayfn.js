...
// array.forEach(n => getEvenNum(n));
array.forEach(getEvenNum); // 함수에 해당값을 알아서 각자 넣어 줌?
...
//find 
// console.log(array);
result = array.find(val => val > 10); // 첫번째 해당 값
console.log(result);
console.log("============")
result = array.findIndex(val => val > 10); // 첫번째 해당 인덱스
console.log(result);
